...
// Array to store registered users (Updated with your real Card and Keychain!)
UserData userList[] = {
  {"873a83b4", "HST-01", "Harsh Vardhan", "", false}, // Your RFID Card
  {"ea6fe880", "HST-02", "Viraj", "", false},         // Your RFID Keychain
  {"5f93979", "HST-03", "Vaayu", "", false},         // Placeholder slot
};
